...
class ReadinessService:
    ...
    def calculate_readiness_scores(self, wardrobe_items: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        # We use strict counts.
        # Readiness is 0% if the user has < 3 items total.
        if len(wardrobe_items) < 3:
            return {
                "Winter": {"score": 0, "strengths": [], "gaps": [], "recommendations": []},
                "Summer": {"score": 0, "strengths": [], "gaps": [], "recommendations": []},
                "Formal": {"score": 0, "strengths": [], "gaps": [], "recommendations": []}
            }
        ...
        coats = cat_counts.get("Coat", 0) + cat_counts.get("Jacket", 0) + cat_counts.get("Outerwear", 0)
        sweaters = cat_counts.get("Sweater", 0) + cat_counts.get("Knitwear", 0)
        ...
        tshirts = cat_counts.get("T-shirt", 0) + cat_counts.get("Tops", 0) + cat_counts.get("Shirts", 0)
        ...
        dress_shirts = cat_counts.get("Dress Shirt", 0) + cat_counts.get("Formal Shirt", 0)
        ...
        # Removed mock Monsoon and Travel items because they cannot be deterministically inferred without proper tags
