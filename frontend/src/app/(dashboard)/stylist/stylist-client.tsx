...
import { SidebarListSkeleton } from "@/components/ui/skeleton-loaders";
...
export default function StylistClient() {
  ...
  const { sessionQuery, sendMessageMutation, error } = useChat(activeSessionId);
      ...
      >
        ...
        <div className="w-80 flex-shrink-0 flex flex-col gap-4">
          <button
            ...
            className="flex items-center gap-2 w-full px-4 py-3 bg-brand-purple hover:bg-brand-purple/90 text-white rounded-xl transition-colors disabled:opacity-50"
          >
