    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-inkwell relative">
      ...
      <Card className="w-full max-w-sm z-10">
        <CardContent className="p-8">
          ...
          <Button type="button" variant="outline" className="w-full relative h-11" onClick={handleGoogleLogin}>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-wider">
              <span className="bg-surface px-2 text-cloudburst font-medium">Or continue with</span>
            </div>
          </div>
